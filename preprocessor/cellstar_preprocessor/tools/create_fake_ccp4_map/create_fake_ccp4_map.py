...
def create_fake_ccp4_map(grid_size: tuple[int, int, int], filepath: Path, dtype, axis_order: tuple):
    ccp4 = gemmi.Ccp4Map()
...
if __name__ == '__main__':
    ...
    create_fake_ccp4_map(grid_size=grid_size, filepath=map_filepath, dtype=np.float32, axis_order=(2, 1, 0))