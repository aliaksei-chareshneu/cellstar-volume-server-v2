...
def _get_ome_tiff_channel_annotations(volume_channel_annotations, zarr_structure, channel_ids_dict: dict[str, str]):
...
def extract_ome_tiff_image_annotations(internal_volume: InternalVolume):
    ...
    ometiff_metadata = internal_volume.custom_data['dataset_specific_data']['ometiff']['ometiff_source_metadata']
