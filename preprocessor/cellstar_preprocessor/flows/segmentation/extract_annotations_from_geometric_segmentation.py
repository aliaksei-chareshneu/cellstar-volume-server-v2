...
from cellstar_db.models import AnnotationsMetadata, DescriptionData, EntryId, GeometricSegmentationData, GeometricSegmentationInputData, SegmentAnnotationData, ShapePrimitiveInputData, TargetId
