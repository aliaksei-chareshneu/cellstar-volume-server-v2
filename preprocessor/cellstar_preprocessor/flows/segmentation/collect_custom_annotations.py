...
from cellstar_preprocessor.flows.common import open_zarr_structure_from_path, update_dict


def collect_custom_annotations(input_path: Path, intermediate_zarr_structure_path: Path):
