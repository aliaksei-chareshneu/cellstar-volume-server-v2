from cellstar_db.models import GeometricSegmentationData, GeometricSegmentationInputData, GeometricSegmentationSetsMetadata, MeshComponentNumbers, Metadata, TimeInfo

from cellstar_preprocessor.flows.common import (
    get_downsamplings,
    open_zarr_structure_from_path,
)
from cellstar_preprocessor.flows.constants import GEOMETRIC_SEGMENTATIONS_ZATTRS, RAW_GEOMETRIC_SEGMENTATION_INPUT_ZATTRS
...
def extract_metadata_geometric_segmentation(internal_segmentation: InternalSegmentation):
    ...
    for gs_set in geometric_segmentation_data:
        ...
        time_units = 'millisecond' if not input_data.time_units else input_data.time_units
        time_info: TimeInfo = {
            'end': 0,
            'kind': 'range',
            'start': 0,
