...
import shutil
from cellstar_preprocessor.flows.constants import INIT_ANNOTATIONS_DICT, INIT_METADATA_DICT
from cellstar_preprocessor.tests.helper_methods import download_map_for_tests, download_omezarr_for_tests, download_sff_for_tests
...
class TestContext:
    ...
    def _init_zarr_structure(self):
        ...
        self.intermediate_zarr_structure_path = self.working_folder / self.test_input["entry_id"]
    ...
    def __init__(self, test_input: TestInput, working_folder: Path,):
