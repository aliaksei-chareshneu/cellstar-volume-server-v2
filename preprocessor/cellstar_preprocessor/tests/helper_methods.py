...
def get_sff_internal_segmentation(test_input: TestInput, segmentation_path: Path, intermediate_zarr_structure: Path):
...
def get_internal_volume_from_input(test_input: TestInput, volume_path: Path, intermediate_zarr_structure: Path):
...
def get_omezarr_internal_segmentation(omezar_test_input: TestInput, segmentation_path: Path, intermediate_zarr_structure: Path):
    # p = download_omezarr_for_tests(omezar_test_input['url'])
    internal_segmentation = InternalSegmentation(
    intermediate_zarr_structure_path=intermediate_zarr_structure,
    segmentation_input_path=segmentation_path,
