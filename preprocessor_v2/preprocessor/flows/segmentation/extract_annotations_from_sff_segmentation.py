...
# PLAN:
# sample - extract_ome_zarr_annotations(ome_zarr_root, source_db_id: str, source_db_name: str):
    d = {
        'entry_id': {
        ...
        'details': internal_segmentation.raw_sff_annotations['details'],
        'name': internal_segmentation.raw_sff_annotations['name'],
