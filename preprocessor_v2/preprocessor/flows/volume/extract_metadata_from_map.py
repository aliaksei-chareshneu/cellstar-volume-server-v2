...
def _get_origin_and_voxel_sizes_from_map_header(mrc_header: object, volume_downsamplings: list[int]):
...
def _get_volume_sampling_info(root_data_group, sampling_info_dict, mrc_header: object, volume_downsamplings: list[int]):
    ...
    origin, voxel_sizes_in_downsamplings = _get_origin_and_voxel_sizes_from_map_header(mrc_header=mrc_header,
